...
public class MainActivity extends AppCompatActivity {
    ...
    {
        String githubQueryUrl = mSearchBoxEditText.getText().toString();
        URL githubSearchUrl = NetworkUtils.buildUrl(githubQueryUrl);
        mSearchBoxEditText.setText(githubSearchUrl.toString());
    }
    @Override
