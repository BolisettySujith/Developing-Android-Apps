...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String ContentOfQueryURl = mUrlDisplayTextView.getText().toString();
        outState.putString(SEARCH_QUERY_URL_EXTRA,ContentOfQueryURl);

        String ContentsOfRawJson = mSearchResultsTextView.getText().toString();
        outState.putString(Search_raw_JSON,ContentsOfRawJson);
    }
}