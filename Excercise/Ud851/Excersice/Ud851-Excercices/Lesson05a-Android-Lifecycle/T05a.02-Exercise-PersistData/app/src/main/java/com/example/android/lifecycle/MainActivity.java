...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState !=null){
            if(savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                String AllPreviousLifeCycleCallBack = savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        String LifeCycleDisplayOnTextView = mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY,LifeCycleDisplayOnTextView);
