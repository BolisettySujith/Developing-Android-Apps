...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        new WeatherFetcher().execute(location);
    }
    ...
    public class WeatherFetcher extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            ...
            URL weatherRequests = NetworkUtils.buildUrl(location);

            try{
                String JSONWeatherResponce = NetworkUtils.getResponseFromHttpUrl(weatherRequests);
                String[] simpleJSONWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, JSONWeatherResponce);
